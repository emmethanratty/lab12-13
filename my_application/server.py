...
def queues_index():
	...
	curl -s -X GET -H 'Accept: application /json' http://localhost:5000/queues | python -mjson.tool
 	curl -s -X GET -H 'Accept: application /json' 83.212.127.208:8080/queues | python -mjson.tool
	"""
	all = []
	conn = get_conn()
...
def queues_create():
	"""
	Create queue
	curl -X POST -H 'Content-Type: application/json' http://localhost:5000/queues -d '{"name": "emmetq"}'
	curl -X POST -H 'Content-Type: application/json' 83.212.127.208:8080/queues -d '{"name": "emmetq"}'	
...
def queues_remove(name):
	"""
	Delete queue
	curl -X DELETE -H 'Accept: application/json' http://localhost:5000/queues/emmetq
	curl -X DELETE -H 'Accept: application/json' 83.212.127.208:8080/queues/emmetq
...
def messages_count(name):
	...
	curl -X GET -H 'Accept: application/json' http://localhost:8080/queues/emmetq/msgs/count
	curl -X GET -H 'Accept: application/json' 83.212.127.208:8080/queues/emmetq/msgs/count
	"""
...
def messages_write(name):
	...
	curl -s -X POST -H 'Accept: application/json' http://localhost:8080/queues/emmetq/msgs -d '{"content": "this is the queue message"}' 
	curl -s -X POST -H 'Accept: application/json' 83.212.127.208:8080/queues/emmetq/msgs -d '{"content": "this is the queue message"}'
	"""
...
def messages_read(name):
	...
	curl -X GET -H 'Accept: application/json' http://localhost:8080/queues/emmetq/msgs
	curl -X GET -H 'Accept: application/json' 83.212.127.208:8080/queues/emmetq/msgs
	"""
...
def messages_consume(name):
	...
	curl -X DELETE -H 'Accept: application/json' http://localhost:8080/queues/emmetq/msgs
	curl -X DELETE -H 'Accept: application/json' 83.212.127.208:8080/queues/emmetq/msgs
	"""
